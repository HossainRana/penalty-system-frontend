...
import HgsDashboard from '../views/hgs-dashboard/index';
import Vehicle from '../views/vehicle';
import Penalty from '../views/penalty';
import TollHgs from '../views/hgs_toll';
...
export const routes = (isLoggedIn, verified, email) => [

    {
        ...
        children: [
            ...
            {path: '/hgs-birim', element: <HgsDashboard />},
            {path: '/arac', element: <Vehicle />},
            {path: '/ceza', element: <Penalty />},
            {path: '/gecis-ucre', element: <TollHgs />},
            ...
            {path: '/yeni-ucret-ekle', element: <FormContainer  formType={ formTypes.newToll } />},
